...
namespace GameRental
{
    ...
    {
        string ConString = "Data Source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=\"D:\\Youssef\\Data Base\\GameRentalقديم\\GameRental.mdf\";Integrated Security=True;Connect Timeout=30";
        ...
        public void addGame()
        {
            ...
            sCommand.CommandText = "INSERT INTO GAME (GNAME, CATEGORY, RENT_PRICE_PER_DAY, VENDORNAME, RELEASEDATE) VALUES ('" + gName.Text + "', '" + gCat.Text + "', " + gRent.Text + ", '" + gVen.Text + "', '" + gDateReleased.Text + "')";
        ...
        public void updateInfo()
        {
            ...
            sCommand.CommandText = "UPDATE CLIENT SET FNAME = '" + FN2.Text + "' WHERE USERNAME = '" + UN + "'; UPDATE CLIENT SET LNAME = '" + LN2.Text + "'  WHERE USERNAME = '" + UN + "' ; UPDATE CLIENT SET PASSWORD = '" + PW2.Text + "' WHERE USERNAME = '" + UN + "'; UPDATE CLIENT SET ADMIN = " + (isAdmin2.Checked ? 1 : 0) + " WHERE USERNAME = '" + UN + "';";
        ...
        public void searchGame()
        {
            ...
            {
                SqlCommand sCommand = new SqlCommand("SELECT * FROM GAME WHERE " + returnName() + " LIKE '%" + gameSearchBx1.Text + "%'");
            ...
            else if (GamesFilters.Text == "Release Date")
            {
                ...
                sCommand = new SqlCommand("select * from GAME where RELEASEDATE >= '" + GameDateFrom.Text + "' and RELEASEDATE <= '" + GameDateTo.Text + "'");
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.Yes)
            {
                ...
                sCommand.CommandText = "INSERT INTO RENT(GNAME, USERNAME, DATE) VALUES('" + NewRentGameSearch.Text + "', '" + UN + "', '" + dt1 + "')";
        ...
        public void getUpdatedReport()
        {
            ...
            if (sReader.Read())
            {
                ReportText.Text = ReportText.Text + sReader["TOPGAME"].ToString() + " With " + sReader["RENTERS"].ToString() + " Renters.\r\n\r\n";
            }
            ...
            if (sReader3.Read())
            {
                ReportText.Text = ReportText.Text + sReader3["FN"].ToString() + ' ' + sReader3["LN"].ToString() + " With " + sReader3["RENTS"].ToString() + " Rentings.\r\n\r\n";
            }
            ...
            if (sReader4.Read())
            {
                ReportText.Text = ReportText.Text + sReader4["VENDOR"].ToString() + " With " + sReader4["RENTS"].ToString() + " Rentings.\r\n\r\n";
            }
        ...
        private void UserSearchBox_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                SqlCommand sCommand = new SqlCommand("SELECT * FROM CLIENT WHERE USERNAME LIKE '%" + UserSearchBox.Text + "%'");
